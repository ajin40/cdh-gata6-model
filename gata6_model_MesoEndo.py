...
def dudt(U, dox, p, t):
    ...
    dfoxf1_dt = dfoxf1_rna(foxf1, GATA6, FOXA2, b0, b1, b3, gata6_n, fox_n, KM_21, KM_G1) * t
    ...
    return nanog + dnanog_dt, gata6 + dgata6_dt, foxa2 + dfoxa2_dt, foxf1 + dfoxf1_dt, NANOG + dNANOG_dt, GATA6 + dGATA6_dt, FOXA2 + dFOXA2_dt, FOXF1 + dFOXF1_dt
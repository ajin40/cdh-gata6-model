...
class GATA6_Adhesion_Coupled_Simulation(Simulation):
    ...
    def setup(self):
        ...
        # Not used in model
        self.div_thresh = self.agent_array(initial={"NANOG": lambda: 18, "GATA6": lambda: 51, "FOXA2": lambda: 51})
        self.division_set = self.agent_array(initial={"NANOG": lambda: np.random.rand() * 18, "GATA6": lambda: 0, "FOXA2": lambda: 0})
